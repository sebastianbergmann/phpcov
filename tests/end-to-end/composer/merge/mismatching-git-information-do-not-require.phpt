--TEST--
phpcov merge --do-not-require-matching-git-information --text /tmp/file ../../fixture/mismatching-git/coverage
--INI--
...
$_SERVER['argv'][2] = '--do-not-require-matching-git-information';
$_SERVER['argv'][3] = '--text';
$_SERVER['argv'][4] = $tmp;
$_SERVER['argv'][5] = __DIR__ . '/../../../fixture/mismatching-git/coverage';
