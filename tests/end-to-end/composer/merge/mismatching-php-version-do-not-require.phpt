--TEST--
phpcov merge --do-not-require-matching-php-version --text /tmp/file ../../fixture/mismatching-php-version/coverage
--INI--
...
$_SERVER['argv'][2] = '--do-not-require-matching-php-version';
$_SERVER['argv'][3] = '--text';
$_SERVER['argv'][4] = $tmp;
$_SERVER['argv'][5] = __DIR__ . '/../../../fixture/mismatching-php-version/coverage';
